# Based on gunpowder/nodes/scan.py from gunpowder 1.2.2
...
class Scan(BatchFilter):
    ...
    def provide(self, request):
        ...
        if self.num_workers > 1:
            ...
            for i in tqdm.tqdm(range(num_chunks), dynamic_ncols=True):
            ...
            for i, shift in tqdm.tqdm(enumerate(shifts), total=num_chunks, dynamic_ncols=True):
